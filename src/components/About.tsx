  ...
  const qualities = [
    {
      ...
      description: "Passionné par le machine learning et l'analyse de données",
    },
    {
      icon: Code,
      title: "Développement Fullstack",
      description: "Expertise en React, Node.js, Python et Java",
    },
    {
      icon: Database,
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          <div className="space-y-6 order-2 lg:order-1">
            ...
            >
              Étudiant passionné en Master Science de Données et IA à l'EMIT, je
              transforme les idées en solutions technologiques innovantes. Mon
              parcours combine développement fullstack et intelligence
              artificielle pour créer des applications qui font la différence.
            </p>
            <p
              className={`text-lg leading-relaxed ${
                isDarkMode ? "text-gray-300" : "text-gray-700"
            ...
            >
              ...
              (React, Node.js, Spring boot, Python) et l'
              <span className="font-semibold text-purple-600">
                intelligence artificielle
              </span>
              , j'ai déjà réalisé plusieurs projets concrets incluant des
              applications de gestion déployées en production et des solutions
              IA primées en hackathon.
            </p>
            <p
              className={`text-lg leading-relaxed ${
                isDarkMode ? "text-gray-300" : "text-gray-700"
            ...
            >
              Toujours en quête d'apprentissage et d'innovation, je cherche à
              contribuer à des projets ambitieux où technologie rime avec impact
              positif. Mon objectif : devenir un expert reconnu en IA tout en
              gardant une approche pragmatique du développement.
            </p>
          </div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-16">
          {qualities.map((quality, index) => (
            <div
              key={index}
              className={`p-6 rounded-xl hover:shadow-lg transition-all duration-300 hover:-translate-y-1 ${
                isDarkMode
