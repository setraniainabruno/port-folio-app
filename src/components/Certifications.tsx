  ...
  const certifications = [
    {
      ...
      hasImage: false,
      imageUrl: null,
      linkUrl: "https://www.hackerrank.com/certificates/iframe/465ce0cf9e57",
    },
    {
    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          >
            Mon parcours de formation continue et mes certifications
            professionnelles
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          {certifications.map((cert, index) => (
            <div
              key={index}
              className={`rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 overflow-hidden ${
